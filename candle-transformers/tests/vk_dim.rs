...
fn dim() -> Result<()> {
    ...
    println!(
        ...
        md(
            &a.matmul(&v)?,
            &a.to_device(&vk)?.matmul(&v.to_device(&vk)?)?
        )?
    );
    // 3d batch 1
    ...
    println!(
        ...
        md(
            &a3.matmul(&v3)?,
            &a3.to_device(&vk)?.matmul(&v3.to_device(&vk)?)?
        )?
    );
    // 4d like attention
    ...
    println!(
        ...
        md(
            &a4.matmul(&v4)?,
            &a4.to_device(&vk)?.matmul(&v4.to_device(&vk)?)?
        )?
    );
    // 4d N=256
    ...
    println!(
        ...
        md(
            &a4.matmul(&v4b)?,
            &a4.to_device(&vk)?.matmul(&v4b.to_device(&vk)?)?
        )?
    );
    Ok(())
}
